    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('admin', 'Admin'), ('resident', 'Resident'), ('staff', 'Staff')], max_length=10)),
                ('phone_number', models.CharField(max_length=20, null=True)),
                ('address', models.TextField(max_length=250, null=True)),
                ('role', models.CharField(choices=[('manager', 'Manager'), ('doctor', 'Doctor'), ('nurse', 'Nurse'), ('caretaker', 'Caretaker'), ('cook', 'Cook'), ('driver', 'Driver')], max_length=20)),
